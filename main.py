"""Scrape Air Tractor listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Air Tractor Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=air%20tractor&s-original-search=air%20tractor",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=air%20tractor"),
    ("ASO", "https://aso.com/search?q=Air%20Tractor"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Air Tractor Listings</h2>
    <p>View additional Air Tractor Aircraft listings at these fine sites:</p>
